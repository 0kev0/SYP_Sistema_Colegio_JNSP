...
public final class Gestion_Transacciones extends javax.swing.JFrame {
...
//lo que cambiaria es el diseno, y las clases para el objeto y lista
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gestion_Transacciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestion_Transacciones().setVisible(true);
            }
        });
    }
