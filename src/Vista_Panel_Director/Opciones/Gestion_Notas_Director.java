...
import Modelo.Director.Modelo_GestionNotas_Director;
...
public final class Gestion_Notas_Director extends javax.swing.JInternalFrame {

    private final Modelo.Director.Modelo_GestionNotas_Director Objeto_GestionNotas = new Modelo.Director.Modelo_GestionNotas_Director();
    private List<Modelo.Director.Modelo_GestionNotas_Director> List_Notas;
    ...
    private void TB_BuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TB_BuscarKeyReleased
        ...
        if (Palabra.equals("")) {
            ...
            List<Modelo_GestionNotas_Director> obj;
            ...
            try {
                ...
                for (Modelo_GestionNotas_Director item : obj) {
    ...
    public void Get_ListadoNotas(JTable tabla, int grado, int id_materia) {
        ...
        for (Modelo_GestionNotas_Director item : List_Notas) {
            double prom = 0;
            for (int i = 0; i < 4; i++) {
                prom += item.getNotas().get(i) * .10;
            }
