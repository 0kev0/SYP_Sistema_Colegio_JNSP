...
public final class Resumen_AsistenciaporAlumno extends javax.swing.JInternalFrame {
    ...
    public Resumen_AsistenciaporAlumno() {
        initComponents();
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (COL == 9) {
                    ...
                    if ("Pendiente".equals(estado)) {
                        int idActividad = Integer.parseInt(Tbl_RegistroAsistencia.getValueAt(ROW, 0).toString());
                        int nie = Integer.parseInt(Tbl_RegistroAsistencia.getValueAt(ROW, 1).toString());

                        String nombre = Tbl_RegistroAsistencia.getValueAt(ROW, 2).toString();
                        String apellido = Tbl_RegistroAsistencia.getValueAt(ROW, 3).toString();
                        int periodo = Integer.parseInt(Tbl_RegistroAsistencia.getValueAt(ROW, 4).toString());
                        String actividad = Tbl_RegistroAsistencia.getValueAt(ROW, 5).toString();
...
//                        Asignar_Nota notaObtenida = new Asignar_Nota(idActividad, periodo, Objeto_AsignarNota, Tbl_RegistroAsistencia);
//                        notaObtenida.setVisible(true);

                        System.out.println("Editable column: " + COL);
                    } else {
                        Funciones.Funciones.showMessageDialog("Problema", "Ya se a calificado la actividad.");
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 940, 290));
